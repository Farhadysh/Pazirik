    ...
    <div class="factor_body">
        <div class="fac_name">
            <div class="fac_style">
                ...
                <span> فاکتور مشتری: {{$factor->order->user->name}}  {{$factor->order->user->last_name}} <span></span></span>
            </div>
        </div>
        <div class="data">
            <div class="data_send">
        ...
        <div class="factor_list">
            <div class="list_top">
                ...
                @foreach($factor->factorProducts as $products)
                    <div class="fac_lis_content">
                        ...
                        <span>{{number_format($products->price * $products->count)}}</span>
                    </div>
                @endforeach
            </div>
            <div class="list_bottom">
                ...
                <div class="service">
                    ...
                    <span>{{number_format($factor->collecting)}}</span>
                </div>
                <div class="service">
                    <span>حمل و نقل</span>
                    <span>{{number_format($factor->transport)}}</span>
                </div>
                <div class="service">
                    <span>تخفیف</span>
                    <span>{{number_format($factor->discount)}}</span>
                </div>
                <div class="service">
                    <span>اجرت کل</span>
        ...
        <div class="info_content">
            <div class="info_right">
                ...
                <span>{{$factorDescription->value}}</span>
            </div>
            <div class="info_left">
                <div class="left_top">
