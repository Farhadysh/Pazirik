...
return [
    ...
    */
    'attributes' => [
        ...
        'terms' => 'شرایط',
        'province_id' => 'استان',
        'res_name' => 'نام و نام خانوادگی',
        'res_mobile' => 'شماره موبایل',
        'registration_number' => 'شماره ثبت',
        'national_id' => 'شناسه ملی',
        'code' => 'کد اقتصادی',
        'percent' => 'درصد',
        'code_voucher' => 'کد تخفیف',
        'starts_at' => 'از تاریخ',
        'expires_at' => 'تا تاریخ',
        'count' => 'محدودیت',
        'max_voucher' => 'سقف مبلغ تخفیف',
        'body' => 'توضیحات',
        'role_id' => 'مقام',
        ...
        'level' => 'رتبه',
        'cost' => 'مبلغ',
        'product_list[]' => 'لیست کالا',
        'config_password' => 'تکرار کلمه عبور',
